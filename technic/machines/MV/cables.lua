...
if minetest.get_modpath("digilines") then
	...
	if minetest.get_modpath("digistuff") then
		...
		minetest.register_craft({
			output = 'technic:mv_digi_cable 1',
			type = "shapeless",
			recipe = {'digilines:wire_std_00000000', 'technic:mv_cable',            'digilines:wire_std_00000000'},
		})
		minetest.register_craft({
			output = 'technic:mv_digi_cable_plate_1 1',
			type = "shapeless",
			recipe = {'digilines:wire_std_00000000', 'technic:mv_cable_plate_1',    'digilines:wire_std_00000000'},
		})
	end
