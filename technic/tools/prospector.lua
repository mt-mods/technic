...
technic.register_power_tool("technic:prospector_mk2", {
	...
	on_use = function(toolstack, user, pointed_thing)
		...
		local _, look_radius = get_field(meta)
		look_radius = look_radius * 7
...
if not minetest.registered_items["pipeworks:teleport_tube_1"] then
	...
	minetest.register_craftitem('technic:teleport_tube_1', {
		description = "Teleporting Pneumatic Tube Segment (disabled)",
		inventory_image = "pipeworks_teleport_tube_inv.png",
	})
	minetest.register_alias("pipeworks:teleport_tube_1", "technic:teleport_tube_1")
	minetest.register_craft({
		output = 'technic:teleport_tube_1',
		recipe = {
			{technic.materials.mese_crystal, 'technic:copper_coil', technic.materials.mese_crystal},
...
minetest.register_craft({
	...
	recipe = {
		{mat.pick_silver, "default:goldblock", "pipeworks:teleport_tube_1"},
...
minetest.register_craft({
	...
	recipe = {
		{mat.pick_mithril, mat.mithril_block, "pipeworks:teleport_tube_1"},
		{"basic_materials:brass_ingot", "technic:control_logic_unit_adv", "basic_materials:brass_ingot"},
