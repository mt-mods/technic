...
local check_node_around = function(pos)
	...
	if node.name == "default:water_source" or node.name == "default:water_flowing"
		or node.name == "mcl_core:water_source" or node.name == "mcl_core:water_flowing" then return 1 end
	if node.name == "default:lava_source"  or node.name == "default:lava_flowing"
		or node.name == "mcl_core:lava_source" or node.name == "mcl_core:lava_flowing" then return 2 end
	return 0
end
